...
def Wang_Disjoint_Experment():
    ...
    The model is trained on AWF777 and tested on Wang100 and the set of websites
    ...
    for size_of_problem in SOP_list:
        ...
        for n_shot in n_shot_list:
            ...
            acc_list_Top5 = []
            for i in range(10):
                signature_vector_dict, test_vector_dict = create_test_set_Wang_disjoint(features_model=features_model,
